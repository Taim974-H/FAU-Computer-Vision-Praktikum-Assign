...
def run_ransac(cloud_img, threshold, num_iterations):
    """
...
def main():
    ...
    x = 2
    file_path = f'CV-proj.Ex1/data/example{x}kinect.mat'
    ...
    floor_model, valid_points, floor_inliers,valid_mask,inliers_mask = run_ransac(cloud_img, num_iterations=3000, threshold=0.039)
